...
export const FPR_SCHEDULE_2026 = [
  ...
  { id: "unity_day", when: "Thu Aug 27 · 5:30–10:30 PM + Fri Aug 28 · 4:30–11:00 PM" },
...
export const ROUND_CONSTRAINTS = {
  ...
  unity_day: {
    label: "unity (2 nights)",
    when: "Thu Aug 27 evening + Fri Aug 28 evening",
    formality: 2,
    duration: "5+ hours each night, walking between houses",
    evaluate: [
      "hem: campus-appropriate sitting and walking",
      "shoes: flat or low — can they do 5 hours without blisters",
      "fabric: late-august berkeley — breathable, not heavy linen that wrinkles",
      "if one purchase: works for BOTH Thu and Fri (or flag they need two looks)",
  ...
  sisterhood_day: {
    ...
    evaluate: [
      "shoes: non-negotiable walk/stand test — block heel max unless clearly padded",
...
export function buildBerkeleyRushContextBlock(context = {}) {
  ...
  const lines = [
    ...
    "formality rises each round. unity is 2 evenings. sisterhood + philanthropy are full days.",
...
GOOD (unity, stilettos):
title: "wrong shoe for unity"
body: "thin 4 inch heel. you walk between houses for hours thu and fri. get a block heel or flat sandal."
