...
const CAMPAIGNS = {
  ...
  orientation_night: (person) => {
    ...
    return {
      subject: "recruitment starts tonight",
      text: `${hi}

orientation is tonight, and unity day 1 is tomorrow at 5:30.

if you haven't decided what you're wearing yet, show yom what you're choosing between — it tells you which one works for the round and the one thing it would change.

${cta}
${link}

new this week: you can send a whole outfit at once. a photo of the top, one of the shorts, one of the shoes — it reads them together instead of one piece at a time.
...
— ban + mal`,
      html: shell(
        `<p>${hi}</p>
<p>orientation is tonight, and <b>unity day 1 is tomorrow at 5:30</b>.</p>
<p>if you haven't decided what you're wearing yet, show yom what you're choosing between — it tells you which one works for the round, and the one thing it would change.</p>`,
        link,
        cta
      ),
      footer: `<p>new this week: a whole outfit at once — a photo of the top, one of the shorts, one of the shoes, read together.</p><p>good luck tonight.<br>— ban + mal</p>`,
    };
  },
};
